            ...
            elseif (is_category() && !empty($wp_query->posts)) {
                ...
                foreach ($transnet_blogs as $trans_blog) {
                    if ($blog_id == $trans_blog['blog_id']) {
                        $translated_urls[$trans_blog['blog_id']] = zwt_get_trans_url('category', $blog_id);
                ...
                foreach ($transnet_blogs as $trans_blog) {
                    if ($blog_id == $trans_blog['blog_id']) {
                        $translated_urls[$trans_blog['blog_id']] = zwt_get_trans_url('post_tag', $blog_id);
                ...
                foreach ($transnet_blogs as $trans_blog) {
                    if ($blog_id == $trans_blog['blog_id']) {
                        $translated_urls[$trans_blog['blog_id']] = zwt_get_trans_url($taxonomy_name, $blog_id);
