...
function zwt_lang_switcher_fn($ls_type) {
    ...
    if (!empty($languages)) {
        ...
        ?>
			...
			<ul>
			    <li class="dropdown">
					  <a class="dropdown-toggle" href="#"><?php echo($show_flag) ? '<img class="drop-arrow" src="'. $active_lang["country_flag_url"].'"/>': ''; ?> <span><?php echo $active_lang['translated_name'] ?></span></a>
